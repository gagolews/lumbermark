...
class lumbermark_build_ext(build_ext):
...
with open("lumbermark/__init__.py", "r", encoding="utf8") as fh:
...
setuptools.setup(
    name="lumbermark",
    version=__version__,
    description="Lumbermark: Fast and Robust Clustering with Outlier Detection",
    ...
    python_requires=">=3.9",
    download_url="https://github.com/gagolews/lumbermark",
    url="https://lumbermark.gagolewski.com/",
    project_urls={
        "Bug Tracker":        "https://github.com/gagolews/lumbermark/issues",
        "Documentation":      "https://lumbermark.gagolewski.com/",
        "Source Code":        "https://github.com/gagolews/lumbermark",
    ...
    cmdclass={
        "sdist": lumbermark_sdist,
        "build_ext": lumbermark_build_ext
    },
    ext_modules=[
